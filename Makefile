...
CFLAGS := -I$(QUESTASIM_HOME)/include         \
	  ...
	  -I$(VERILATOR_ROOT)/include/vltstd \
          ...
          -std=c++11 -I../corev_apu/tb/dpi -Os -march=native
...
vcs: vcs_build
	cd $(vcs-library) && ./simv  $(if $(VERDI), -verdi -do $(root-dir)/init_testharness.do,) +permissive -sv_lib ../work-dpi/ariane_dpi +PRELOAD=$(elf-bin) +tohost_addr=$(shell $$RISCV/bin/riscv-none-elf-nm -B $(elf-bin) | grep -w tohost | cut -d' ' -f1) +permissive-off ++$(elf-bin)| tee vcs.log
